...
for ds in ["Muon0", "Muon1"]:
    datasets["data"]["names"].extend(
        [
            f"{ds}_Run2025C-Prompt-v1",
            f"{ds}_Run2025C-Prompt-v2",
            f"{ds}_Run2025D-Prompt-v1",
            f"{ds}_Run2025E-Prompt-v1",
            f"{ds}_Run2025F-Prompt-v1",
            f"{ds}_Run2025F-Prompt-v2",
            f"{ds}_Run2025G-Prompt-v1",
        ]
    )
